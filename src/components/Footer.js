      ...
      <footer className="footer">
        <div className="footer__info">
          ...
          <p className="footer__info__blurb">
            F.F.P. is a project designed and implmented solely by myself, Graeme
            Fall. I am a BSc(Hons) Computing and IT (Software) graduate, having
            studied at the Open Uni. <br />
            The purpose of the application is to work on Web Development and IT
            ...
            <br />
            If you have any questions about F.F.P. then email me at
